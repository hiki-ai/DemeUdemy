    ...
    <div className="space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {stats.map((stat, i) => (
          <motion.div 
            ...
            className="bg-white p-4 md:p-6 rounded-[1.5rem] border border-border relative overflow-hidden group hover:border-primary/20 transition-all duration-500"
          >
      ...
      <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-4">
             {pendingApprovals.map((item, i) => (
                <motion.div 
                  ...
                  transition={{ delay: i * 0.1 }}
                  className="bg-white p-3 md:p-5 rounded-[1.5rem] border border-border flex items-center justify-between group hover:border-primary/30 transition-all duration-500"
                >
        ...
        <div className="space-y-8">
           ...
           <div className="bg-white p-4 md:p-8 rounded-[2rem] border border-border relative overflow-hidden shadow-sm">
              <div className="space-y-10 relative z-10">
                ...
                <Button variant="outline" className="w-full mt-8 h-12 text-sm uppercase tracking-widest font-black">View Detailed Logs</Button>
           </div>
        </div>
      </div>
    </div>
